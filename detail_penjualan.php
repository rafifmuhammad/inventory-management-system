...
$transactions = getData("SELECT * 
    FROM tb_penjualan, tb_detail_penjualan, tb_barang 
    WHERE tb_penjualan.id_penjualan = tb_detail_penjualan.id_penjualan 
    AND tb_barang.id_barang = tb_detail_penjualan.id_barang 
    AND tb_penjualan.id_penjualan = '$id_penjualan'
");
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Market - Detail Penjualan</title>
    <meta
      name="viewport"
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="mt-0 header-title">Tabel Detail Penjualan</h4>
