...
$today = date('Y-m-d');
$products = getData("SELECT * FROM tb_barang_keluar, tb_barang 
  WHERE tb_barang_keluar.id_barang = tb_barang.id_barang 
  AND tb_barang_keluar.tanggal_keluar = '$today'
");
...
if (isset($_POST['cek_tanggal'])) { 
  ...
  $products = getData("SELECT * FROM tb_barang_keluar, tb_barang 
    WHERE tb_barang.id_barang = tb_barang_keluar.id_barang
    AND tb_barang_keluar.tanggal_keluar BETWEEN '$tgl_awal' AND '$tgl_akhir'
  ");
                ...
                <div class="card-body">
                  ...
                  >
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?= $product['id_keluar']; ?></td>
                        <td><?= $product['nama_barang']; ?></td>
                        <td><?= number_format($product['jumlah'], 0, ',', '.'); ?></td>
                        <td><?= $product['tanggal_keluar']; ?></td>
                        <td>
                          <a href="./delete_product_out.php?id_keluar=<?= $product['id_keluar']; ?>" onclick="return confirm('Yakin hapus barang keluar?');"
