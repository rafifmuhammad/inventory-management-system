...
// Query product
$product = getData("SELECT * FROM tb_barang WHERE id_barang = '$id_barang'")[0];
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-title-box">
                ...
                <h4 class="page-title">Ubah Data Barang</h4>
              </div>
              <!--end page-title-box-->
            </div>
            <!--end col-->
          ...
          <div class="row" id="form_new_product">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="mt-0 header-title">Form Ubah Barang</h4>

                  <!-- Input product form start -->
                  <form action="" method="post">
                    <input type="hidden" name="id_barang" id="id_barang" value="<?= $product['id_barang']; ?>">
